...
<head>
    ...
    <title>Редактировать контрольную работу</title>
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    <div class="card-header bg-warning text-dark">
                        <h4 class="mb-0">✏️ Редактировать контрольную работу</h4>
                    </div>
                        ...
                        <form action="{{ route('teacher.lessons.update', $lesson->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="lesson_number" 
                                       name="lesson_number" 
                                       value="{{ old('lesson_number', $lesson->lesson_number) }}"
                                       min="1">
                                <small class="form-text text-muted">
                                    Укажите номер, если существует генератор заданий
                                </small>
                                @error('lesson_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('theory') is-invalid @enderror" 
                                          id="theory" 
                                          name="theory" 
                                          rows="6">{{ old('theory', $lesson->theory) }}</textarea>
                                @error('theory')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
